...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->fileMap = array(
            ...
            'fos_user.user_provider.username_email' => __DIR__.'/getFosUser_UserProvider_UsernameEmailService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('onIOoOHD4A', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SP0K5OqImi', 0, 'AzRnfUoYyY0X58mA3dT1qB', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('erl6I5qxYM', 0, 'AzRnfUoYyY0X58mA3dT1qB', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BUtmBItjo3', 0, 'AzRnfUoYyY0X58mA3dT1qB', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3dwmxpLT5E', 0, 'AzRnfUoYyY0X58mA3dT1qB', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'rgravier89@gmail.com',
            'mailer_password' => 'Jm\'aRejt\'e92!',
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_PARTICULIER' => array(
                    0 => 'ROLE_USER',
                ),
                'ROLE_NATURALISTE' => array(
                    0 => 'ROLE_PARTICULIER',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'rgravier89@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Jm\'aRejt\'e92!',
