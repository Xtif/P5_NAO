 ...
 */
class Pictures extends \AppBundle\Entity\Pictures implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Pictures' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Pictures' . "\0" . 'alt', '' . "\0" . 'AppBundle\\Entity\\Pictures' . "\0" . 'url', '' . "\0" . 'AppBundle\\Entity\\Pictures' . "\0" . 'observation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pictures $proxy) {
